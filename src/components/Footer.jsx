          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'flex-end' }}>
              ...
              <div style={{ 
                ...
                <span style={{ color: 'rgba(255,255,255,0.6)' }}>Developed and managed by <a href="https://github.com/RITHWIK-DUDALA" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary)', fontWeight: '600', letterSpacing: '0.5px', textDecoration: 'none', transition: 'opacity 0.2s' }} onMouseEnter={(e) => e.target.style.opacity = 0.8} onMouseLeave={(e) => e.target.style.opacity = 1}>D R S S G</a></span>
